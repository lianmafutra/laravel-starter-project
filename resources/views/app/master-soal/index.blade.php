...
@endpush
@section('header')
    <x-header title="Master Soal"></x-header>
@endsection
@section('content')
    <div class="col-12">
        <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm col-auto col-md-auto">
                            <a href="{{ route('master-soal.create') }}" class="btn btn-sm btn-primary">
